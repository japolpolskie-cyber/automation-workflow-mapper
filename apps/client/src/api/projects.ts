...
export const projectApi = {
  ...
  updateEditor: (id: string, workflow: Project['workflow'], workflowSet: Project['workflowSet'], visualGraph: Project['visualGraph']) => request<Project>(`/workflows/${id}/editor`, { method: 'PATCH', body: JSON.stringify({ workflow, workflowSet, visualGraph }) }),
