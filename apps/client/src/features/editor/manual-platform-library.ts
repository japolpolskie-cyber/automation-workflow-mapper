...
export const manualPlatformLibraries: Record<Platform, ManualPlatformLibrary> = {
  n8n: {
    ...
    items: [
      ...
      item('condition', 'Condition', 'condition'), item('router', 'Switch / Router', 'router'),
      ...
      item('error', 'Error Handler', 'error_handler'), item('merge', 'Merge', 'merge'),
  ...
  make: {
    ...
    items: [
      ...
      item('action', 'Action Module', 'action'), item('router', 'Router', 'router', 'Make.com', 'Router'),
      ...
      item('messaging', 'Messaging', 'messaging'), item('notification', 'Notification', 'notification'),
      item('approval', 'Approval', 'human_approval'), item('retry', 'Retry', 'retry'),
      item('error', 'Error Handler', 'error_handler'), item('sub-scenario', 'Callable Scenario', 'sub_workflow', 'Make.com', 'Callable scenario'),
      item('end', 'End', 'end'), customNode,
    ],
  },
  zapier: {
    ...
    items: [
      ...
      item('action', 'Action', 'action'), item('paths', 'Paths', 'router', 'Zapier', 'Paths'),
