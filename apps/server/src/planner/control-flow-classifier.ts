...
const candidates: Candidate[] = [
  ...
  { type: 'approval', expression: /\b(?:approve|approved|approval|authorize|sign[- ]?off|green[- ]?light|reject|rejected|decline)\b/i, reason: 'The requirement contains a human approval or rejection boundary.', confidence: 0.98, waitKind: 'human' },
  ...
  { type: 'subworkflow', expression: /\b(?:call|invoke|run|execute)\s+(?:the\s+)?(?:sub-?workflow|child workflow|reusable workflow|subprocess)\b/i, reason: 'A reusable workflow boundary is explicit.', confidence: 0.98 },
