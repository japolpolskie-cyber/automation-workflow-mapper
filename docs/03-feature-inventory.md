...
| Capability-detection contract | Partially implemented | Phase D Sprints 1–3A provide deterministic Router, Binary Decision, Wait, and Approval detectors. Router additionally has bounded natural-language routing facts with its exact-pattern rule retained as fallback; semantic preprocessing has not been generalized to other detectors. |
