...
| Canonical internal Workflow Brief schema | Partially implemented | Phase B Sprints 1–2 add strict business entities, triggers, actions, decisions, routes, loops, waits, approvals, merges, iterators, aggregators, and cross-reference validation. Evidence/review contracts remain planned. |
