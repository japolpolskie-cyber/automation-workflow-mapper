...
| Conceptual node-function catalog | Partially implemented | Phase C Sprints 1–2 establish 23 entries and detailed Router, Binary Decision, Retry, Follow-up, Revision, Polling, and Return-to-step contracts. Remaining entries stay foundation status. |
