...
| Capability-detection contract | Partially implemented | Phase D Sprints 1–3A provide deterministic Router, Binary Decision, Wait, and Approval detectors. Router and Wait additionally use bounded natural-language facts before their exact-pattern fallbacks; Binary Decision and Approval retain their current strategies. |
