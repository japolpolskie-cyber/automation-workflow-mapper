...
| Conceptual node-function catalog | Partially implemented | Phase C Sprint 1 establishes 23 business-level catalog entries and a detailed Router contract. Other entries remain foundation status. |
