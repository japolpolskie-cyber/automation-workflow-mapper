...
4. Inspect the detection summary, capability suggestions, semantic routes, Wait and Approval boundaries, clarification questions, draft status, scaffolding warnings, and formatted raw JSON.
5. Use **Clear** to remove the local input and response.

## Current boundaries

- Only Router, Binary Decision, Wait, and Approval detectors are available.
