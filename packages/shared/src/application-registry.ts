...
export const applicationRegistry: readonly ApplicationDefinition[] = [
  ...
  application('trello', 'Trello', 'project-management', 'trello', ['Find Card', 'Create Card', 'Update Card', 'Move Card']),
  ...
  application('google-calendar', 'Google Calendar', 'calendar', 'google-calendar', ['Find Event', 'Create Event', 'Update Event']),
